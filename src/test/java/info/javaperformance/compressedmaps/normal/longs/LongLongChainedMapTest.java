...
public class LongLongChainedMapTest extends TestCase
{
    ...
    protected ILongLongMap makeMap( final long size, final float fillFactor )
    {
        return LongMapFactory.singleThreadedLongLongMap( size, fillFactor );
    }
