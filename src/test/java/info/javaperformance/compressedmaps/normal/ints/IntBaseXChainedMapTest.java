...
public class IntBaseXChainedMapTest extends TestCase {
	...
	protected IIntObjectMap<String> makeMap(final long size, final float fillFactor) {
		return IntMapFactory.singleThreadedIntObjectMap(size, fillFactor, new BaseXStringSerializer(BaseX.DICTIONARY_89));
	}
