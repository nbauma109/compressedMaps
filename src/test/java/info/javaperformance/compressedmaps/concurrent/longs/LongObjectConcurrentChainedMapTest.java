...
public class LongObjectConcurrentChainedMapTest extends TestCase
{
    ...
    protected ILongObjectConcurrentMap<String> getMap( final int size, final float ff )
    {
        return LongMapFactory.concurrentLongObjectMap( size, ff, new GenericStringSerializer( Charset.forName("UTF-8") ) );
    }
    ...
    private void testPutHelper( final int threads, final float ff ) throws InterruptedException {
        ...
        final ILongObjectConcurrentMap<String> map = getMap( INITIAL_CAPACITY, ff );
    ...
    private static class Adder implements Runnable
    {
        ...
        private final ILongObjectConcurrentMap<String> m_map;

        public Adder( long from, long to, CountDownLatch startGate, CountDownLatch endGate, ILongObjectConcurrentMap<String> map ) {
            m_from = from;
            m_to = to;
    ...
    private static class Updater implements Runnable
    {
        ...
        public Updater( long from, long to, CountDownLatch startGate, CountDownLatch endGate, ILongObjectConcurrentMap<String> map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
    ...
    private static class AddUpdateRemover implements Runnable
    {
        ...
        public AddUpdateRemover( long from, long to, CountDownLatch startGate, CountDownLatch endGate, ILongObjectConcurrentMap<String> map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
    ...
    private static class Remover implements Runnable
    {
        ...
        public Remover( long from, long to, CountDownLatch startGate, CountDownLatch endGate, ILongObjectConcurrentMap<String> map ) {
            m_from = from;
            m_to = to;
            m_startGate = startGate;
            m_endGate = endGate;
