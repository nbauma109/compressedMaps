 ...
 * The main differences are lack of TreeMap support and replacement of Object keys with {@code int} keys.
 *
 * This class will be replaced with another implementation in one of subsequent releases.
 *
 * @param <V> Value type
 */
@Deprecated
public class ConcurrentIntObjectMap<V>
{
    ...
    static <K,V> boolean casTabAt(Node<V>[] tab, int i,
                                        Node<V> c, Node<V> v) {
