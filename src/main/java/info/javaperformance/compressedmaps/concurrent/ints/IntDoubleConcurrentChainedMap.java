...
public class IntDoubleConcurrentChainedMap implements IIntDoubleConcurrentMap {
	 ...
	 */
	public IntDoubleConcurrentChainedMap(final long size, final float fillFactor, final IIntSerializer keySerializer, final IDoubleSerializer valueSerializer) {
	...
	public double put(final int key, final double value) {
		...
		while (true) {
			...
			if (res != null && compareAndSet(buffers.cur, idx, bucket, res.chain)) {
				...
				final double ret = res.retValue; // must be saved in case of
													// rehash
	 ...
	 * @return A new chain and an old value
	 */
	private UpdateResult addToChainSlow(final long bucket, final Iterator iter, final Block inputBlock, final int inputStartOffset, final int key, final double value) {
