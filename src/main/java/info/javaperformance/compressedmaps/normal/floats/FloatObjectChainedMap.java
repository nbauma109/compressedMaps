 ...
 */
public class FloatObjectChainedMap<V> implements IFloatObjectMap<V>{
     ...
     */
    public FloatObjectChainedMap( final long size, final float fillFactor,
     ...
     */
    private void singleEntry( final SingleThreadedBlock output, final float key, final V value, final int idx )
    {
     ...
     */
    private UpdateResult<V> addToChain( final int index, final float key, final V value )
    {
     ...
     */
    private UpdateResult<V> removeKey( final float key, final int idx )
    {
        final SingleThreadedBlock inputBlock = getBlockByIndex( m_data.getBlockIndex() );
        final int inputStartOffset = m_data.getOffset();
