...
public class LongIntChainedMap implements ILongIntMap{
     ...
     */
    private void singleEntry( final SingleThreadedBlock output, final long key, final int value, final int idx )
    {
    ...
    private static class Iterator    {
        ...
        */
        public int findKey( final long key, final int noValue )
        {
            while ( hasNext() ) {
                advance();
                if ( getKey() == key )
