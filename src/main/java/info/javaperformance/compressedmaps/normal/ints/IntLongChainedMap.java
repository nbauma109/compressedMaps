...
public class IntLongChainedMap implements IIntLongMap {
	 ...
	 */
	public IntLongChainedMap(final long size, final float fillFactor, final IIntSerializer keySerializer, final ILongSerializer valueSerializer, final long blockCacheLimit) {
	...
	@Override
	public synchronized long get(final int key) {
	...
	@Override
	public synchronized long put(final int key, final long value) {
	 ...
	 * @return A new chain and an old value
	 */
	private UpdateResult addToChainSlow(final int index, final Iterator iter, final SingleThreadedBlock inputBlock, final int inputStartOffset, final int key, final long value) {
