 ...
 * footprint.
 */
public class IntDoubleChainedMap implements IIntDoubleMap {
	 ...
	 */
	public IntDoubleChainedMap(final long size, final float fillFactor, final IIntSerializer keySerializer, final IDoubleSerializer valueSerializer, final long blockCacheLimit) {
	...
	@Override
	public synchronized double get(final int key) {
	...
	@Override
	public synchronized double put(final int key, final double value) {
	 ...
	 *            Bucket to use
	 */
	private void singleEntry(final SingleThreadedBlock output, final int key, final double value, final int idx) {
	 ...
	 */
	private UpdateResult addToChain(final int index, final int key, final double value) {
	 ...
	 * @return A new chain and an old value
	 */
	private UpdateResult addToChainSlow(final int index, final Iterator iter, final SingleThreadedBlock inputBlock, final int inputStartOffset, final int key, final double value) {
	...
	private static class UpdateResult {
		...
		public UpdateResult set(double retValue, int sizeChange) {
