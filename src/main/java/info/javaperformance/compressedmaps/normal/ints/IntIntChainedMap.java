...
public class IntIntChainedMap implements IIntIntMap {
	 ...
	 */
	public IntIntChainedMap(final long size, final float fillFactor, final IIntSerializer keySerializer, final IIntSerializer valueSerializer, final long blockCacheLimit) {
	 ...
	 * @return A new chain and an old value
	 */
	private UpdateResult addToChainSlow(final int index, final Iterator iter, final SingleThreadedBlock inputBlock, final int inputStartOffset, final int key, final int value) {
